...
class Statistics(db.model)
    ...
    system_capacity = Colum(db.Integer, nullable=Fasle, default=0)
    system_utilization = Colum(db.Float, nullable=Fasle, default=0.0)
    user_count = Colum(db.Integer, nullable=Fasle, default=0.0)
